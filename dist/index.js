...
var NgxImageZoomComponent = (function () {
    ...
    NgxImageZoomComponent.decorators = [
        { type: Component, args: [{
                    ...
                    styles: [".ngxImageZoomContainer { position: relative; margin: auto; overflow: hidden; } .ngxImageZoomFull { position: absolute; height: auto; max-width: 100%; display: none; } .ngxImageZoomFullContainer { position: absolute; overflow: hidden; } .ngxImageZoomFullContainer.ngxImageZoomLensEnabled { border: 2px solid black; cursor: crosshair; } .ngxImageZoomThumbnail { height: auto; width: 100%; } "]
                },] },
    ];
    /** @nocollapse */
