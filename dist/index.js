...
var NgxImageZoomComponent = (function () {
    ...
    NgxImageZoomComponent.decorators = [
        { type: Component, args: [{
                    ...
                    styles: [".ngxImageZoomContainer { position: relative; margin: auto; overflow: hidden; } .ngxImageZoomFull { position: absolute; height: auto; display: none; } .ngxImageZoomFullContainer { position: absolute; overflow: hidden; } .ngxImageZoomFullContainer.ngxImageZoomLensEnabled { border: 2px solid red; cursor: crosshair; } .ngxImageZoomThumbnail { height: auto; width: 100%; } "]
                },] },
    ];
    /** @nocollapse */
